              ...
              {showCustomCode && user && (
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="text-muted-foreground text-sm font-mono bg-muted px-3 py-2 rounded-lg">
                      slink.ninja/
                    </span>
                    <Input
                      id="customCode"
              ...
              <Card className="bg-gradient-to-r from-primary/10 to-orange-500/10 border-primary/20">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Custom domains, detailed analytics, bulk shortening, and
                    more
                  </p>
                  <Button
                    variant="outline"
          ...
          >
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Your link is ready to share. Track clicks and get insights in
                real-time.
              </p>
            </div>
